...
class PostControllerTest extends TestCase
{
    ...
    {
        //ahora para verificar todos los metodos de un usuario real se crea un usuario
    ...
    public function test_update()
    {
        ...
        //$this->withoutExceptionHandling(); -->con este comando nos puede espesificar dice que esta pasando
        $post = factory(Post::class)->create();
